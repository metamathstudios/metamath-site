                ...
                <div className={styles.nftCollection}>
                  <div className={styles.first}>
                    ...
                    <div
                      className={styles.nft}
                      style={{
                        backgroundImage: `url(/images/Projects/Popup/${props.type}/NFT02.png)`,
                      }}
                    />
                    <div
                      className={styles.nft}
                      style={{
                        backgroundImage: `url(/images/Projects/Popup/${props.type}/NFT03.png)`,
                      }}
                    />
                  </div>
                  <div className={styles.second}>
                    <div
                      className={styles.nft}
                      style={{
                        backgroundImage: `url(/images/Projects/Popup/${props.type}/NFT04.png)`,
                      }}
                    />
                    <div
                      className={styles.nft}
                      style={{
                        backgroundImage: `url(/images/Projects/Popup/${props.type}/NFT05.png)`,
                      }}
                    />
                    <div
                      className={styles.nft}
                      style={{
                        backgroundImage: `url(/images/Projects/Popup/${props.type}/NFT06.png)`,
                      }}
                    />
                  </div>
                </div>
